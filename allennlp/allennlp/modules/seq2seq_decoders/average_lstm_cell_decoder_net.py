...
@DecoderNet.register("averaged_lstm_cell")
class AveragedLstmCellDecoderNet(DecoderNet):
    """
    ...
    def forward(self,
                ...
                source_tokens = None, target_tokens = None, vocab_cust = None, last_prediction = None) -> Tuple[Dict[str, torch.Tensor],
                                                                             torch.Tensor]:
